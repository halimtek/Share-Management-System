...
const Buy = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // 🔥 ALL 12 REQUIRED FIELDS (match backend exactly)
    formData.append("firstname", firstname);
    formData.append("middlename", middlename);
    formData.append("lastname", lastname);
    formData.append("country", country);
    ...
    try {
      ...
      // redirect to chapa checkout link
      if (data?.message) {
        router.push(data.message);
      }
    } catch (err) {
  ...
  return (
    <Heator>
      <div className="max-w-lg mx-auto bg-gray-400 rounded-lg p-6 mt-10">
        <Head>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <input placeholder="Middle Name" value={middlename}
            onChange={(e) => setMiddleName(e.target.value)} className="input" />

          <input placeholder="Last Name" value={lastname}
            onChange={(e) => setLastName(e.target.value)} className="input" />

          <input placeholder="Country" value={country}
            onChange={(e) => setCountry(e.target.value)} className="input" />

          <input placeholder="City" value={city}
            onChange={(e) => setCity(e.target.value)} className="input" />

          <input placeholder="Subcity" value={subcity}
            onChange={(e) => setSubcity(e.target.value)} className="input" />

          <input placeholder="Wereda" value={wereda}
            onChange={(e) => setWereda(e.target.value)} className="input" />

          <input placeholder="Email" value={email}
            onChange={(e) => setEmail(e.target.value)} className="input" />

          <input placeholder="Phone No" value={phoneNo}
          ...
          <input placeholder="House No" value={houseNo}
            onChange={(e) => setHouseNo(e.target.value)} className="input" />

          <input placeholder="Share Amount" type="number" value={shareamount}
            onChange={(e) => setShareAmount(e.target.value)} className="input" />
